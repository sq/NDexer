...
namespace MovablePython
{
    public class Hotkey : IMessageFilter
	{
		...
		[XmlIgnore]
		private IWin32Window windowControl;
		...
		public bool Register(IWin32Window windowControl)
        {
